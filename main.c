...
int attendre_choix_deplacement_piece(int x,int y,int *position_finale_x,int *position_finale_y)
{
	...
	int possibilite_deplacement[8][8], i,j,clic=0, piece_indeplacable=1,temps_precedent=SDL_GetTicks();
	SDL_Event evenement;
...
{	
	SDL_Rect position_image,sprite;
	int i,j,k,liste_pieces_en_jeu[2][5],nb_pion_max=0,nb_adoubement=0,decalage=0;
...
{
	int k,l,joueur_deplace=0,piece_deplace=0,a_bouge_deplace=0,a_bouge_au_tour_prececent_deplace=0,est_en_echec=0,position_precedente_x=0,position_precedente_y=0;
